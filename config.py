...
# __C.dataset.appearance_feat = '{}_appearance_feat.h5' #sutd-traffic_appearance_feat_clip_image_uniform
# sutd-traffic_appearance_feat_clip_image_l14
# sutd-traffic_appearance_feat_resnet3d_slowfast_uniform_save
# sutd-traffic_appearance_feat_clip_image_40fps
# sutd-traffic_appearance_feat_resnet3d_slowfast_25fps
__C.dataset.appearance_feat = '{}_appearance_feat_clip_image.h5' #sutd-traffic_appearance_feat_clip_image_uniform

__C.dataset.save_dir = ''
__C.dataset = dict(__C.dataset)

__C.dataset.annotation_file = ''
__C.dataset.annotation_file_val = ''
# experiment name
